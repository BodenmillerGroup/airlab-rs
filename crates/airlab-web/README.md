...
export SERVICE_LOG_AGGR_URL="http://<parseable-host>:<parseable-port>/api/v1/ingest"
export SERVICE_LOG_AGGR_AUTH="Basic <base64_user_password>"
export SERVICE_LOG_AGGR_REQUEST_URL="<optional request stream ingest url>"
export SERVICE_LOG_AGGR_FRONTEND_URL="<optional frontend stream ingest url>"
export SERVICE_LOG_AGGR_EVENT_URL="<optional app event stream ingest url>"
export SERVICE_LOG_AGGR_REQUEST_STREAM="airlab_requests"
export SERVICE_LOG_AGGR_FRONTEND_STREAM="airlab_frontend"
export SERVICE_LOG_AGGR_EVENT_STREAM="airlab_events"
export SERVICE_NAME="airlab-web"
